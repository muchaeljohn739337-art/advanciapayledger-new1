...
const DashboardScreen = ({ navigation }) => {
  const { metrics, revenueData, transactions, facilities, isLoading, error, loadDashboardData } = useDashboard();
  ...
  const handleGenerateReport = () => {
    Alert.alert('Generate Report', 'This would generate a comprehensive dashboard report with all metrics and analytics.');
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Healthcare Fintech Platform</Text>
        </View>
