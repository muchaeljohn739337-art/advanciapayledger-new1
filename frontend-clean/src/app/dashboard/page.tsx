...
export default function UserDashboard() {
  ...
  useEffect(() => {
    ...
    // Define callbacks so we can properly remove them
  ...
  }, []); // Socket and load functions are stable, safe to omit
          ...
          <div className="p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <Link href="/medbeds" className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 hover:from-purple-100 hover:to-purple-200 rounded-xl transition group block">
                      ...
                      <p className="font-semibold text-gray-900">Book Wellness Chamber</p>
                    </Link>
            ...
            {activeTab === 'medbeds' && (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Wellness Chamber Booking</h3>
                <p className="text-gray-600 mb-6">Book your wellness chamber session for relaxation and recovery</p>
