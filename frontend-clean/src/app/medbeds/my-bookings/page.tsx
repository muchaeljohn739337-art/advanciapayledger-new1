...
export default function MyBookingsPage() {
  ...
  useEffect(() => {
    ...
    // Define the callback so we can properly remove it
  ...
  }, []); // Socket and loadBookings are stable, safe to omit
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">My Wellness Chamber Bookings</h1>
                <p className="text-gray-600 text-sm">Manage your wellness sessions</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link
          ...
          {filteredBookings.length > 0 ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                {filter === 'all' ? 'Start your wellness journey by booking your first Wellness Chamber session.' :
                 filter === 'upcoming' ? 'Schedule a new Wellness Chamber session for future wellness.' :
