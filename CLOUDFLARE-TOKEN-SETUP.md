...
Use one Cloudflare token per workspace and load it through environment variables. Do not paste tokens into scripts.
...
$env:CLOUDFLARE_ZONE_ID="<zone-id>"
$env:CLOUDFLARE_ACCOUNT_ID="<account-id>"
pwsh -File "..\modular-prop-1\test-cloudflare-api.ps1"
```
...
2. DNS records follow the Hostinger VPS layout in `CLOUDFLARE_DNS_SETUP.md`
...
**Test Script:** ..\modular-prop-1\test-cloudflare-api.ps1
